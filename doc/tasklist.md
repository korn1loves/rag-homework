...
- [x] Создать `doc/DATA.md`.
- [x] Описать источник данных: SQuAD 2.0.
- [x] Описать масштаб выборки.
- [x] Описать, какие поля индексируются.
- [x] Описать, какие поля используются как metadata.
- [x] Указать ограничения данных.
- [x] Добавить ссылку на `doc/DATA.md` из README.
...
- [x] Создать папку `homework/`, если её нет.
- [x] Создать `homework/SUBMISSION.md`.
- [x] Указать в `SUBMISSION.md` ссылку на репозиторий с выполненным заданием.
- [x] Проверить, что репозиторий публичный.
- [x] Проверить, что README содержит инструкцию запуска.
- [x] Проверить, что Streamlit показывает источники.
- [x] Подготовить Pull Request в исходный репозиторий задания.
- [x] Добавить в PR файл `homework/SUBMISSION.md`.
...
- [x] Все итерации 0–10 отмечены как ✅ в таблице прогресса.
- [x] Репозиторий содержит рабочий RAG-pipeline.
- [x] `uv sync` выполняется без ошибок.
- [x] `uv run python scripts/build_index.py` строит индекс.
- [x] `uv run streamlit run app/main.py` запускает UI.
- [x] Streamlit показывает найденные источники: `doc_id`, score и текст чанка.
- [x] Есть 3 demo-вопроса с ответами.
- [x] Есть 1 negative-вопрос с отказом.
- [x] Есть минимум 5 тестов, и они проходят.
- [x] README содержит инструкцию запуска.
- [x] `doc/DATA.md` описывает источник и структуру данных.
- [x] `homework/SUBMISSION.md` содержит ссылку на репозиторий.
